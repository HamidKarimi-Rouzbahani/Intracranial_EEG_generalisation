...
for Patient=[1:39 41:56]
    ...
    elseif Patient==57
        ...
        modality='ecog';
        ictal_trials=[1:3];
        inter_ictal_awake_trials=[1];
        inter_ictal_sleep_trials=[1];
    elseif Patient==58
    ...
    elseif Patient==59
        ...
        modality='ecog';
        ictal_trials=[1:4];
        inter_ictal_awake_trials=[1:2];
        inter_ictal_sleep_trials=[1:2];
    elseif Patient==60
    ...
    if strcmp(ictal_or_inter,'ictal')
        load([Patient_initials,'_All2_Features_Seizure',num2str(ictal_trials(1)),chars,'.mat'])
    elseif strcmp(ictal_or_inter,'interictal')
        load([Patient_initials,'_All2_Features_Interictal',num2str(inter_ictal_trials(1)),chars,'.mat'])
    end
    ...
    for feat=featuress
        ...
        for trial=trials
            ...
            elseif Patient>56 && Patient<59
                patient_data_address=['F:\RESEARCH\Hamid\Multicentre dataset\Additional\sub-jh',Patient_initials,'\ses-presurgery\ieeg\'];
                folder_address=[patient_data_address,'sub-jh',Patient_initials,'_ses-presurgery_task-',ictal_or_inter,'_acq-',modality,'_run-',sprintf('%02d',trial)];
            ...
            c=0;
            Target_area='resect';
            %             contains(channel_info.status_description(ch,:),'soz') &&
