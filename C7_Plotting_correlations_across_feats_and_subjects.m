...
%% Plotting corrleations in within-patient classifications
clc;
clear all;
close all;
...
%% Plotting corrleations in cross-time generalisation
clc;
clear all;
close all;
...
%% Plotting corrleations in cross-patient generalisations
clc;
clear all;
close all;
ictal_or_inter='interictal';
