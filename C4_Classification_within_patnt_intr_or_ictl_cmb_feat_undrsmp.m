    ...
    for Patient=all_patients % patient indices
        ...
        if exist('Xnew','var')
            ...
            for iter_rand=1:1
                ...
                CVO = cvpartition(y_r,'k',10); % 10 fold cross-validation
        ...
        save(['Within_subject_performance_sepnorm',ictal_or_inter,'_all_feats_crcted_feats_imp_100_10.mat'],'Classifiers','Predictions','Ground_truth','impCART','included_feats','-v7.3')
        [ff iter_equalis p]
